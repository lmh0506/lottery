...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _module2 = __webpack_require__(315);

	var _module = _interopRequireWildcard(_module2);

	var _module3 = __webpack_require__(316);
	...
	console.log('module2', _module4.default);
...
/***/ (function(module, exports) {
...

	{
	  var _str = 'string';
	  // 判断字符串是否包含某个字符串
	  console.log('includes', _str.includes('ri'));
	  // 判断字符串是否以某个字符串开始
...

	{
	  ...
	  console.log(abc(_templateObject, user.name, user.info, user.test, user.test2));
	}

	{
	  ...
	  console.log(String.raw(_templateObject3, 1 + 2));
	  console.log('Hi\n' + (1 + 2));
	}
...

	{
	  ...
	  try {
	    for (var _iterator3 = ['1', 'c', 'ks'].entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	      ...
	      console.log('index', _index, 'values', _value);
	    }
	  } catch (err) {
...
/***/ (function(module, exports) {
...

	{
	  var _test = function _test(x) {
	    ...
	    // 因为y会先找相同作用域中的x进行赋值 在这里是第一个参数x
	    console.log('作用域', x, y);
	  };

	  var test2 = function test2(a) {
	    var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : x;
	    // 这里因为找不到 去父级的作用域中寻找 所以是父级的值为test的x
	    console.log('作用域', a, y);
	  };
...

	{
	  ...
	  (_console = console).log.apply(_console, [1, 2, 4]); // 将数组转成一个个单个元素
...
/***/ (function(module, exports) {
...

	{
	  ...
	  var a3 = Symbol.for('a3'); // 参数为key值 如果之前有变量定义则用该变量的值赋值 否则用Symbol() 赋值
	  var a4 = Symbol.for('a3'); // 因为a3变量之前定义过  所以  a3与a4相等
...
/***/ (function(module, exports) {
	...
	{
	  var arr = [1, 2, 3, 4, 5];
	  var _list = new Set(arr); // 将数组转换成set类型
...

	{
	  ...
	  _list2.add(5);
	  _list2.add(1);
	  _list2.add(1); // set无法添加相同的元素

	  console.log('list', _list2);

	  var _arr = [1, 2, 3, 1, '2'];
	  var list2 = new Set(_arr); // 利用set进行去重 如果数据类型不同 则不算重复
...

	{
	  ...
	  console.log('has', _list3.has('add')); // 判断是否有某个元素
	  console.log('delete', _list3.delete('add'), _list3); // 删除某个元素
	  _list3.clear(); // 清空list 
...

	{
	  ...
	  try {
	    for (var _iterator4 = _list4.entries()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	      ...
	      console.log('key', _key, 'value', _value2);
	    }
	  } catch (err) {
...

	{
	  ...
	  map.set(_arr4, 456); // map添加元素用set
	  console.log('map', map, map.get(_arr4)); // get方法传入key值 获取value值
	}
...

	{
	  ...
	  // 查
	  var set_exist = set.has({ t: 1 }); // 这里的对象引用地址与之前添加的不同 所以返回false
...

	{
	  ...
	  obj['t'] = 2;
	  console.info('map-set-obj-modify', _map3, _set, obj);

	  // 删
	  _map3.delete('t');
	  _set.delete(item);
	  delete obj['t'];
	  console.info('map-set-obj-delete', _map3, _set, obj);
	}
...
/***/ (function(module, exports) {
...

	{
	  ...
	  var monitor = new Proxy(obj, {
	    // 通过Proxy进行代理 对原始数据进行处理 最后只暴露这个代理对象给用户
	    // 拦截对象属性的读取
...
/***/ (function(module, exports) {
...

	{
	  ...
	  var Parent = function Parent() {
	    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'lmh';
...

	{
	  ...
	  var _Child = function (_Parent3) {
	    _inherits(_Child, _Parent3);
	    ...
	    function _Child() {
	      ...
	      // super的参数列表就是父类的构造函数的参数列表 如果不传参则使用父类的默认值
	      // 子类的属性一定要放在super函数下面
...

	{
	  ...
	  _Parent6.type = 'test';
	  console.log('静态属性', _Parent6.type);
	}
...
/***/ (function(module, exports) {
...

	{
	  ...
	  loadImg('http://img3.imgtn.bdimg.com/it/u=295286015,3475255162&fm=26&gp=0.jpg'), loadImg('http://img2.imgtn.bdimg.com/it/u=3255492702,1431047136&fm=26&gp=0.jpg'), loadImg('http://img5.imgtn.bdimg.com/it/u=3777653310,1405536063&fm=26&gp=0.jpg')]).then(showImgs);
	}

	{
	  ...
	  _loadImg('http://img3.imgtn.bdimg.com/it/u=295286015,3475255162&fm=26&gp=0.jpg'), _loadImg('http://img2.imgtn.bdimg.com/it/u=3255492702,1431047136&fm=26&gp=0.jpg'), _loadImg('http://img5.imgtn.bdimg.com/it/u=3777653310,1405536063&fm=26&gp=0.jpg')]).then(_showImgs);
	}
...
/***/ (function(module, exports) {
...

	{
	  ...
	  console.log('myname', _Test.myname);
	}
